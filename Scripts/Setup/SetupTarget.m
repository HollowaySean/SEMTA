...
scenario.traj = struct( ...
    ...
    'yvel',     200*(0.5*rand(1)+0.5), ...                % Along track velocity in m/s
    'exc',      500*rand(1), ...                % Excursion distance in meters
    'per',      0.2*(2*rand(1)-1), ...                % Excursion period (Nominally 0.05 to 0.2)
    ...
    ... % Static options
